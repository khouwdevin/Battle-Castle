...
public class HeroesInfantry extends Heroes{

    public static final float kill_calavry = 0.1f;
    public static final float kill_archer = 0.4f;

    public HeroesInfantry(int heroes_type, int[] army_type, int[] troops) {
